...
GRANT CREATE  TABLE ON SCHEMA Raw.POS TO ROLE DATAADMIN;
GRANT SELECT ON FUTURE TABLES IN SCHEMA Raw.POS TO ROLE DATAADMIN;
GRANT SELECT ON FUTURE TABLES IN SCHEMA Raw.POS TO ROLE svc;


GRANT USAGE,CREATE SCHEMA ON database Retail TO ROLE DATAADMIN;
GRANT USAGE,CREATE SCHEMA ON database Retail TO ROLE svc;
...
GRANT CREATE  TABLE ON SCHEMA Retail.STG TO ROLE SVC;
GRANT CREATE  VIEW ON SCHEMA Retail.STG TO ROLE SVC;
...
GRANT CREATE  TABLE ON SCHEMA Retail.TRF TO ROLE SVC;
GRANT CREATE  VIEW ON SCHEMA Retail.TRF TO ROLE SVC;
GRANT CREATE  dynamic table ON SCHEMA Retail.TRF TO ROLE SVC;
...
GRANT CREATE  TABLE ON SCHEMA Retail.DWH TO ROLE SVC;
GRANT CREATE  VIEW ON SCHEMA Retail.DWH TO ROLE SVC;

USE ROLE DATAADMIN;
USE WAREHOUSE COMPUTE_WH;

CREATE TABLE Raw.POS.CUSTOMER LIKE SNOWFLAKE_SAMPLE_DATA.TPCH_SF1.CUSTOMER;
ALTER TABLE Raw.POS.CUSTOMER ADD COLUMN UPDATED_DATETIME TIMESTAMP_LTZ;
INSERT INTO RAW.POS.CUSTOMER SELECT *, CURRENT_TIMESTAMP AS UPDATED_DATETIME FROM SNOWFLAKE_SAMPLE_DATA.TPCH_SF1.CUSTOMER;
...
ALTER TABLE Raw.POS.ORDERS ADD COLUMN UPDATED_DATETIME TIMESTAMP_LTZ;
INSERT INTO RAW.POS.ORDERS SELECT *, CURRENT_TIMESTAMP AS UPDATED_DATETIME FROM SNOWFLAKE_SAMPLE_DATA.TPCH_SF1.ORDERS;
...
GRANT USAGE,CREATE SCHEMA ON database Retail_DEV TO ROLE DATAADMIN;
GRANT USAGE,CREATE SCHEMA ON database Retail_DEV TO ROLE svc;
